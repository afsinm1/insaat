...
<body>
    <div class="alert red">asdasdasd asdasdas asdasd</div>
    <div class="container">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12 no-padding">
        <div class="BirimFiyatAgaci">
            ...
            <div class="BirimFiyatAgaciIcerik">
                <ul>
                    <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı
                        <ul>
                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı
                                <ul>
                                    <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı
                                        <ul>
                                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı</li>
                                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı</li>
                                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı</li>
                                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı</li>
                                            <li class="acilirList"><div class="listSimge anim">+</div>MKK / DiA MKK Kırılımı</li>
                ...
                <div class="pozunAnalizi">
                    ...
                    <form>
                        ...
                        <?php  foreach ($pozanaliz as $analiz) : ?>
                            <tr>
                                <td><input class="sec" type="radio" name="secili"></td>
                        ...
                        <input class="duzenlemGonderBtn anim" type="submit" value="Değişiklikleri Kaydet">
                    </form>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Analizi Düzenle</h4>
                <p class="modal-description">Düzenlemek istediğiniz analize ait bilgiyi düzenlemek için düzenlemek istediğiniz yere tıklamanız yeterli.</p>
            </div>
            <div class="modal-body modalVeri">
                <form action="" method="post" role="form">
                <div class="degisiklikKaydi">
                    <button class="anim" type="submit">Değişiklikleri Kaydet</button>
                    <div class="clearfix"></div>
                </div>
                    <table>
                        <tr>
                            ...
                            <?php  foreach ($pozanaliz as $analiz) : ?>
                        <tr>
                            <td><input type="radio" name="secim" value="secim"></td>
                            <td><?php echo $analiz['PozNo'] ?></td>
                            <td><?php echo $analiz['MkkCode'] ?></td>
                            <td><?php echo $analiz['PozTanim'] ?></td>
                            <td><?php echo $analiz['PozTipi'] ?></td>
